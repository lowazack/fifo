...
export default {
  ...
  methods: {
    ...
    store(files, event){
      ...
      axios.post(   this.$apiAdress + '/coreui/resource/' + self.$route.params.bread + '/resource?token=' + localStorage.getItem("authtoken"),
        postData,
        { headers: {
    ...
    getFields (){
      let self = this;
      axios.get(  this.$apiAdress + '/coreui/resource/' + self.$route.params.bread + '/resource/create?token=' + localStorage.getItem("authtoken") )

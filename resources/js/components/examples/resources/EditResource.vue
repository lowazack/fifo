...
export default {
  ...
  methods: {
    ...
    update(files, event) {
      ...
      axios.post(this.$apiAdress + '/coreui/resource/' + self.$route.params.bread + '/resource/' + self.$route.params.id + '?token=' + localStorage.getItem("authtoken"),
          postData,
          {
            headers: {
    ...
    getFields() {
      let self = this;
      axios.get(this.$apiAdress + '/coreui/resource/' + self.$route.params.bread + '/resource/' + self.$route.params.id + '/edit?token=' + localStorage.getItem("authtoken"))

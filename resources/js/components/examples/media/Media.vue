  ...
  methods: {
    croppImage(){
        ...
        self.cropper.getCroppedCanvas().toBlob((blob) => {
            ...
            axios.post(   this.$apiAdress + '/coreui/media/file/cropp', formData )
    ...
    openCroppFileModal(id){
        let self = this
        axios.get(   this.$apiAdress + '/coreui/media/file?id=' + id + '&thisFolder=' + self.thisFolder + '&token=' + localStorage.getItem("authtoken"))
        .then(function (response) {
    ...
    downloadFile(id, name){
        ...
        axios({
            method: 'get',
            url: this.$apiAdress + '/coreui/media/file/download?thisFolder=' + self.thisFolder + '&id=' + id + '&token=' + localStorage.getItem("authtoken"),
    ...
    deleteFolder(){
        let self = this
        axios.post(   this.$apiAdress + '/coreui/media/folder/delete?thisFolder=' + self.thisFolder + '&id=' + self.elementId + '&token=' + localStorage.getItem("authtoken")
        ).then(function(response){
            self.getFoldersAndFiles(self.thisFolder)
    ...
    deleteFile(){
        let self = this
        axios.post(   this.$apiAdress + '/coreui/media/file/delete?thisFolder=' + self.thisFolder + '&id=' + self.elementId + '&token=' + localStorage.getItem("authtoken")
        ).then(function(response){
            self.getFoldersAndFiles(self.thisFolder)
            self.rightCard = 'fileInfo'
    ...
    renameOpenForm(id, type){
        ...
        let self = this
        if(type == 'folder'){
            axios.get(   this.$apiAdress + '/coreui/media/folder?id=' + id + '&token=' + localStorage.getItem("authtoken")
            ).then(function(response){
            ...
            axios.get(   this.$apiAdress + '/coreui/media/file?thisFolder=' + self.thisFolder + '&id=' + id + '&token=' + localStorage.getItem("authtoken")
            ).then(function(response){
                self.name = response.data.name
    ...
    moveFolder(){
        if(this.selectFolder != null){
            let self = this;
            axios.post(   this.$apiAdress + '/coreui/media/folder/move',
            {
                id: this.elementId,
    ...
    moveFile(){
        if(this.selectFolder != null){
            let self = this;
            axios.post(   this.$apiAdress + '/coreui/media/file/move',
            {
                id: this.elementId,
                folder: this.selectFolder,
    ...
    copyFile(id){
        let self = this
        axios.get(   this.$apiAdress + '/coreui/media/file/copy?thisFolder=' + self.thisFolder + '&id=' + id + '&token=' + localStorage.getItem("authtoken")
        ).then(function(response){
            self.getFoldersAndFiles(self.thisFolder)
            self.rightCard = 'fileInfo'
        })
    ...
    renameFolder(){
        let self = this;
        axios.post(   this.$apiAdress + '/coreui/media/folder/update',
        {
            name: this.name,
            id: this.elementId,
            token: localStorage.getItem("authtoken"),
    ...
    renameFile(){
        let self = this;
        axios.post(   this.$apiAdress + '/coreui/media/file/update',
        {
            name: this.name,
            id: this.elementId,
            token: localStorage.getItem("authtoken"),
    ...
    handleFileUpload(files, event){
        ...
        axios.post(   this.$apiAdress + '/coreui/media/file/store?thisFolder=' + self.thisFolder + '&token=' + localStorage.getItem("authtoken"),
            formData,
            { headers: {
    ...
    addFolder(){
        let self = this;
        axios.get(  this.$apiAdress + '/coreui/media/folder/store?thisFolder=' + self.thisFolder + '&token=' + localStorage.getItem("authtoken"))
        .then(function (response) {
            self.getFoldersAndFiles(self.thisFolder)
        }).catch(function (error) {
            console.log(error)
    ...
    getFoldersAndFiles(folderId){
        let self = this;
        axios.get(  this.$apiAdress + '/coreui/media?id=' + folderId + '&token=' + localStorage.getItem("authtoken"))
        .then(function (response) {

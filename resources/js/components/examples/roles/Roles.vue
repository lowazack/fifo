...
export default {
  ...
  methods: {
    ...
    deleteRole ( id ) {
      let self = this;
      let noteId = id;
      axios.post(  this.$apiAdress + '/coreui/roles/' + id + '?token=' + localStorage.getItem("authtoken"), {
        _method: 'DELETE'
      })
    ...
    moveUp( id ){
      let self = this;
      axios.get(  this.$apiAdress + '/coreui/roles/move/move-up?id=' + id + '&token=' + localStorage.getItem("authtoken"))
      .then(function (response) {
    ...
    moveDown( id ){
      let self = this;
      axios.get(  this.$apiAdress + '/coreui/roles/move/move-down?id=' + id + '&token=' + localStorage.getItem("authtoken"))
      .then(function (response) {
          self.message = 'Successfully move role.';
          self.showAlert();
          self.getRoles();
    ...
    getRoles (){
      let self = this;
      axios.get(  this.$apiAdress + '/coreui/roles?token=' + localStorage.getItem("authtoken") )
      .then(function (response) {

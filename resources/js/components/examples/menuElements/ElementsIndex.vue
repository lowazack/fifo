...
export default {
  ...
  methods: {
    ...
    moveUp(id) {
      axios.get(this.$apiAdress + '/coreui/menu/element/move-up?token=' + localStorage.getItem("authtoken") + '&id=' + id)
          .then(() => {
            this.getElements();
          }).catch(() => {
    ...
    moveDown(id) {
      let self = this;
      axios.get(this.$apiAdress + '/coreui/menu/element/move-down?token=' + localStorage.getItem("authtoken") + '&id=' + id)
    ...
    getElements() {
      ...
      axios.get(this.$apiAdress + '/coreui/menu/element?token=' + localStorage.getItem("authtoken") + '&menu=' + self.$route.params.menu)
          .then(function (response) {

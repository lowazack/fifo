...
export default {
  ...
  methods: {
    ...
    updateSelectParent(){
        let self = this;
        axios.get(  this.$apiAdress + '/coreui/menu/element/get-parents?token=' + localStorage.getItem("authtoken") + '&menu=' + self.menuelement.menu
        )
    ...
    store() {
        ...
        axios.post(  this.$apiAdress + '/coreui/menu/element/store?token=' + localStorage.getItem("authtoken"),
          self.menuelement
        )
        .then(function (response) {
            self.name = '';
    ...
    getData() {
      let self = this;
      axios.get(  this.$apiAdress + '/coreui/menu/element/create?token=' + localStorage.getItem("authtoken") + '&id=' + self.$route.params.menu )
      .then(function (response) {

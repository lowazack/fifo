...
export default {
  ...
  methods: {
    ...
    save() {
        ...
        axios.post(  this.$apiAdress + '/coreui/menu/element/update?token=' + localStorage.getItem("authtoken"),
          {
    ...
    getData() {
      let self = this;
      axios.get(  this.$apiAdress + '/coreui/menu/element/edit?token=' + localStorage.getItem("authtoken") + '&id=' + self.$route.params.id )
      .then(function (response) {

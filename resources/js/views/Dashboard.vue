...
<script>
import MainChartExample from '../components/examples/charts/MainChartExample'
import WidgetsDropdown from '../components/examples/widgets/WidgetsDropdown'
import WidgetsBrand from '../components/examples/widgets/WidgetsBrand'
